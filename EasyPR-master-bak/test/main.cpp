...
int main(int argc, const char* argv[]) {
	...
	//easypr::demo::test_plate_locate_batch("resources/image/general_test/");
	//easypr::demo::test_plate_judge("resources/image/general_test_pr/");
	//easypr::demo::test_plate_detect("resources/image/real/");
	//easypr::demo::test_chars_segment("resources/image/test/");
	//easypr::demo::test_plate_detectpr();
	easypr::demo::test_plateRecognizeMain();
	//easypr::demo::test_chars_recognisepr();
	//easypr::demo::test_chars_recognisecaffe();
	system("pause");
	return 0;
  std::shared_ptr<easypr::Kv> kv(new easypr::Kv);
  kv->load("etc/chinese_mapping");
